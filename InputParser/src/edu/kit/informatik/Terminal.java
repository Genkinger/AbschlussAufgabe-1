...
public final class Terminal {
     ...
     * <blockquote><pre>
     * edu.kit.informatik.Terminal.printLine("Error, " + message);</pre>
     * </blockquote>
     *
    ...
    public static void printLine(final char[] charArray) {
        /*
         * Note: This method's sole purpose is to ensure that the edu.kit.informatik.Terminal-class behaves exactly as
